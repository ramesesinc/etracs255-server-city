...
alter table batchgr add memoranda varchar(500)
;
...
alter table `rpt_syncdata_forsync`  add state varchar(25)
;
...
alter table cashreceipt_share add receiptitemid varchar(50)
;
